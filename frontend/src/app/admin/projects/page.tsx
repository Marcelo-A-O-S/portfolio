...
export default function ProjectPage() {
    return (
        <>
            <main className="relative mx-auto flex min-h-screen inset-0 w-screen max-w-[1440px] justify-center bg-white dark:bg-background ">
                <section className="relative w-screen h-svh px-10 py-18">
                    <div className="flex p-10 items-center justify-between">
                        ...
                        <div className="flex gap-2 items-center">
                            <Link className={buttonVariants({ variant: "default" }) + ``}  href={"/admin/projects/create"}>Create Post</Link>
                        </div>
                    </div>
