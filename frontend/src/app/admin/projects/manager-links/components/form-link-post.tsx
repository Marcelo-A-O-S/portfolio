...
import { useAddLinkPost } from "@/hooks/Post/Link/useAddLinkPost";
import { useUpdateLinkPost } from "@/hooks/Post/Link/useUpdateLinkPost";
...
export default function FormLinkPost({ link, postId }: FormLinkProps) {
    const { data: linkTypes } = useGetLinkTypes();
    const { data: languages } = useLanguages();
    const { mutateAsync: createLink, isPending: isAdding } = useAddLinkPost();
    const { mutateAsync: updateLink, isPending: isUpdating } = useUpdateLinkPost();
