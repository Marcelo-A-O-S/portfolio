...
import { getLinksPostColumns } from "./components/links-post-columns";
import FormLinkPost from "./components/form-link-post";
...
export default function ManagerLinksPage() {
    ...
    const columns = useMemo(() => getLinksPostColumns(), [])
    if (postId == undefined)
        notFound();
